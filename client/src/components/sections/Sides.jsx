...
export default function Sides() {
  ...
  const fetchDishes = async () => {
    try {
      ...
      console.error("Lỗi lấy danh sách món kèm:", err.message);
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
            ...
            <div className="order-2 md:order-1 relative group">
              ...
              <div className="aspect-[4/5] bg-emerald-100 dark:bg-emerald-800 rounded-sm p-3 overflow-hidden shadow-2xl border border-emerald-300 dark:border-emerald-700">
                <img 
                  ...
                  src={dishes[0]?.ImageUrl || "https://images.unsplash.com/photo-1569058242253-92a9c755a0ec?w=500&h=600&fit=crop"}
                />
              </div>
              ...
              <div className="absolute -bottom-8 -right-8 w-48 h-48 bg-emerald-700 p-6 shadow-[0_20px_50px_rgba(16,185,129,0.3)] hidden md:flex flex-col justify-center items-center text-center">
                ...
                <span className="text-emerald-100 font-sans text-[10px] uppercase tracking-[0.2em] mt-2">Loại Món Kèm</span>
              </div>
            </div>
            ...
            <div className="order-1 md:order-2">
              ...
              <h2 className="text-4xl md:text-6xl font-bold mb-8 font-['Noto_Serif'] leading-tight">
                {dishes[0]?.DishName || "Món Kèm Đặc Biệt"}
              </h2>
              <p className="text-emerald-700 dark:text-emerald-300 text-lg leading-relaxed mb-12 font-['Noto_Serif'] italic">
                {dishes[0]?.Description || "Các món ăn kèm được chọn lọc kỹ lưỡng để kết hợp với từng tô phở, mang lại hương vị tuyệt vời nhất."}
              </p>
        ...
        {dishes.length === 0 && !error && (
          <div className="text-center py-20">
            <p className="text-emerald-700 text-lg">Chưa có sản phẩm trong danh mục Món Kèm. Hãy thêm từ admin panel!</p>
          </div>
        )}
